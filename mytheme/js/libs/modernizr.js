/*!
 * modernizr v3.3.1
 * Build http://modernizr.com/download?-animation-audio-audioloop-audiopreload-backdropfilter-backgroundblendmode-backgroundcliptext-backgroundsize-bgpositionshorthand-bgpositionxy-bgsizecover-borderimage-borderradius-boxshadow-boxsizing-checked-classlist-cookies-cssall-cssanimations-csscalc-csschunit-csscolumns-cssexunit-cssfilters-cssgradients-cssmask-csspointerevents-csspositionsticky-csspseudoanimations-csspseudotransitions-cssreflections-cssremunit-cssscrollbar-csstransforms-csstransforms3d-csstransitions-cssvhunit-cssvmaxunit-cssvminunit-cssvwunit-cubicbezierrange-customevent-display_runin-displaytable-ellipsis-eventlistener-exiforientation-flexbox-flexboxlegacy-flexboxtweener-flexwrap-fontface-fullscreen-generatedcontent-hashchange-hiddenscroll-history-json-lastchild-localstorage-lowbandwidth-mediaqueries-multiplebgs-nthchild-opacity-overflowscrolling-pointerevents-preserve3d-queryselector-requestanimationframe-rgba-siblinggeneral-sizes-srcset-svg-textshadow-touchevents-urlparser-video-videoautoplay-videoloop-videopreload-webgl-webintents-wrapflow-addtest-atrule-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixedcssvalue-prefixes-setclasses-shiv-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
